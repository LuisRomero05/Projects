...
{
    public class CustomerRepositoryTest : IRepository<tbCustomers, View_tbCustomers_List>
    {
        public int Delete(int Id, int Mod)
        {
            ...
            using var db = new SqlConnection("data source=WINDOWS-N9P87K2\\SQLEXPRESS; initial catalog=LOGISTIC_SMART_AHM; user id=romero05; password=holamundo123");
        ...
        {
            using var db = new LogisticSmartContext("data source=WINDOWS-N9P87K2\\SQLEXPRESS; initial catalog=LOGISTIC_SMART_AHM; user id=romero05; password=holamundo123");
            return db.tbCustomers.Where(expression).FirstOrDefault();
        }
