...
namespace AHM.Logistic.Smart.Api.TestControllers
{
    ...
    [ApiController]
    public class OrdersControllerTest : ControllerBase
    {
        private readonly IMapper _mapper;
        public OrdersSalesServices _ordersSalesServices = new OrdersSalesServices();

        public OrdersControllerTest(IMapper mapper)
        {
            _mapper = mapper;
        }
        ...
        {
            var result = _ordersSalesServices.ListSaleOrder();
            return Ok(result);
        }
        ...
        public IActionResult SaleOrdersDetails(int Id)
        {
            ...
            var result = _ordersSalesServices.DetailsSalesOrder(x => x.sor_Id == Id);
            return Ok(result);
        }
        ...
        public IActionResult Insert(SaleOrdersModel items)
        {
            ...
            var result = _ordersSalesServices.RegisterSaleOrder(item, data);
            return Ok(result);
        }
        ...
        public IActionResult InsertDetails(List<OrderDetailsUpdateModel> items)
        {
            ...
            var result = _ordersSalesServices.RegisterOrdersDetails(data);
            return Ok(result);
        }
        ...
        public IActionResult Update(SaleOrdersModel items)
        {
            var item = _mapper.Map<tbSaleOrders>(items);
            var data = _mapper.Map<List<tbOrderDetails>>(items.sor_details);
            var result = _ordersSalesServices.UpdateSaleOrder(item, data);
            return Ok(result);
        }
        ...
        {
            var result = _ordersSalesServices.DeleteSaleOrder(Id, Mod);
            return Ok(result);
        }
        ...
        {
            var result = _ordersSalesServices.DeleteOrdersDetail(Id, proId, Mod);
            return Ok(result);
        }
    }
}
