...
namespace AHM.Logistic.Smart.Api.TestControllers
{
    ...
    public class ProductsControllerTest : ControllerBase
    {
        ...
        public ProductsControllerTest(IMapper mapper)
        {
            _mapper = mapper;
        }
        ...
        {
            var result = _productsService.List();
            return Ok(result);
        }
        ...
        {
            var IdFind = Id;
            var result = _productsService.Find(x => x.pro_Id == Id);
            return Ok(result);
        }
        ...
        public IActionResult Insert(ProductsModel items)
        {
            ...
            var result = _productsService.Insert(item);
            return Ok(result);
        }
        ...
        public IActionResult Update(int Id, ProductsModel items)
        {
            var item = _mapper.Map<tbProducts>(items);
            var IdUser = Id;
            var result = _productsService.Update(item, IdUser);
            return Ok(result);
        }
        ...
        public IActionResult StockUpdate(int Id, ProductStockModel items)
        {
            var item = _mapper.Map<tbProducts>(items);
            var IdUser = Id;
            var result = _productsService.UpdateStock(IdUser, item);
            return Ok(result);
        }
        ...
        public IActionResult Delete(int Id, int Mod)
        {
            var ModUser = Mod;
            var IdUser = Id;
            var result = _productsService.Delete(IdUser, ModUser);
            return Ok(result);
        }
