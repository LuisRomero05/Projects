...
namespace AHM.Logistic.Smart.Api.Controllers
{
    ...
    public class CallResultController : ControllerBase
    {
        ...
        public CallResultController(ClientsService clientsService, IMapper mapper)
        {
            _mapper = mapper;
            _clientsService = clientsService;
        }

        // GET: api/ListCallResult/List
        /// <summary>
        /// End point para visualizar los registros de la tabla "ListCallResult".
        /// </summary>
        /// <remarks>
        /// Se mostraran todos los registros de la tabla "ListCallResult" sin requerir de ningun dato a ingresar.        
        /// </remarks>
        ...
        {
            var result = _clientsService.ListCallResult();
            return Ok(result);
        }
    }
}
