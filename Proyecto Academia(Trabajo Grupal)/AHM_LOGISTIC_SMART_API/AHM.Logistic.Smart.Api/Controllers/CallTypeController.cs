...
namespace AHM.Logistic.Smart.Api.Controllers
{
    ...
    public class CallTypeController : ControllerBase
    {
        ...
        public CallTypeController(ClientsService clientsService, IMapper mapper)
        {
            _mapper = mapper;
            _clientsService = clientsService;
        }

        // GET: api/ListCallType/List
        /// <summary>
        /// End point para visualizar los registros de la tabla "ListCallType".
        /// </summary>
        /// <remarks>
        /// Se mostraran todos los registros de la tabla "ListCallType" sin requerir de ningun dato a ingresar.        
        /// </remarks>
        ...
        {
            var result = _clientsService.ListCallType();
            return Ok(result);
        }
    }
}
