...
namespace AHM.Logistic.Smart.Api.Controllers
{
    ...
    public class PrioritiesController : ControllerBase
    {
        ...
        public PrioritiesController(ClientsService clientsServices, IMapper mapper)
        {
            _mapper = mapper;
            _clientsService = clientsServices;
        }

        // POST: api/Priorities/List
        /// <summary>
        /// End point para visualizar los registros de la tabla "Priorities".
        /// </summary>
        /// <remarks>
        /// Se mostraran todos los registros de la tabla "Priorities" sin requerir de ningun dato a ingresar.
        /// </remarks>
        ...
        {
            var result = _clientsService.ListPriorities();
            return Ok(result);
        }
