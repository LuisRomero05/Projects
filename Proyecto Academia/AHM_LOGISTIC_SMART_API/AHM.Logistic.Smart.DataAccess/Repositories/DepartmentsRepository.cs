...
{
    public class DepartmentsRepository : IRepository<tbDepartments, View_tbDepartments_List>
    {
        ...
        {
            using var db = new LogisticSmartContext();
            return db.tbDepartments.Where(expression).OrderByDescending(x=>x.dep_Id).FirstOrDefault(); 
        }
