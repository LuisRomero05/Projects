...
namespace AHM.Logistic.Smart.Api.TestControllers
{
    ...
    [ApiController]
    //[Authorize]
    public class CotizationsControllerTest : ControllerBase
    {
        private readonly IMapper _mapper;
        public CotizationsServices _cotizationsServices = new CotizationsServices();
        public CotizationsControllerTest( IMapper mapper)
        {
            _mapper = mapper;
        ...
        {
            var result = _cotizationsServices.ListCotization();
            return Ok(result);
        }
        ...
        {
            var result = _cotizationsServices.DetailsCotizations(x => x.cot_Id == Id);
            return Ok(result);
        }
        ...
        public IActionResult Insert(CotizationsModel items)
        {
            ...
            var result = _cotizationsServices.RegisterCotization(item, data);
            return Ok(result);
        }
        ...
        public IActionResult InsertDetails(List<CotizationsDetailUpdateModel> items)
        {
            ...
            var result = _cotizationsServices.RegisterCotizationDetails(data);
            return Ok(result);
        }
        ...
        public IActionResult Update(CotizationsModel items)
        {
            ...
            var result = _cotizationsServices.UpdateCotizations(item, data);
            return Ok(result);
        }
        ...
        {
            var result = _cotizationsServices.DeleteCotizations(Id, Mod);
            return Ok(result);
        }
        ...
        {
            var result = _cotizationsServices.DeleteDetail(proId, Id, Mod);
            return Ok(result);
        }
    }
}
